...
$errors[MAILINGLISTS_MAIL_SET_FROM_FAILED] = dgettext('mailinglists', 'Failed to set from address.');
$errors[MAILINGLISTS_MAIL_SEND_TO_FAILED]  = dgettext('mailinglists', 'Failed to set to address.');
